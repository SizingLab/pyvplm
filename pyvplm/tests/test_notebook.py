...
from pyvplm.addon.variablepowerlaw import buckingham_theorem, automatic_buckingham, reduce_parameter_set, declare_func_x_to_pi, regression_models, perform_regression, force_buckingham, pi_sensitivity, pi_dependency
...
class Notebook1(unittest.TestCase):
...
class Notebook2(unittest.TestCase):
    def test_choice(self):
        print('\n Notebook2 tested...')  
...
class Notebook3(unittest.TestCase):
    def test_choice(self):
        print('\n Notebook3 tested...')        
        # Declare physical variables and set
...
class Notebook4(unittest.TestCase):
    def test_choice(self):  
        print('\n Notebook4 tested...')  
